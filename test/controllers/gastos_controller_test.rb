...
class GastosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post gastos_url, params: { gasto: { dtgasto: @gasto.dtgasto, tipo_gasto_id: @gasto.tipo_gasto_id, valor: @gasto.valor } }
    end
  ...
  test "should update gasto" do
    patch gasto_url(@gasto), params: { gasto: { dtgasto: @gasto.dtgasto, tipo_gasto_id: @gasto.tipo_gasto_id, valor: @gasto.valor } }
